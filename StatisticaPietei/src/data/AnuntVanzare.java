...
public class AnuntVanzare implements Comparable<AnuntVanzare> {
	...
	public AnuntVanzare(String title, double price, int rooms, double area, String floor, String link,String location) {
		super();
		this.title = title;
		this.price = price;
		this.rooms = rooms;
	...
	@Override
	public int compareTo(AnuntVanzare o) {
